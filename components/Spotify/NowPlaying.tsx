...
export default function NowPlaying() {
  ...
  if (!nowPlaying?.songUrl || !nowPlaying.title || !nowPlaying.artist) {
    return (
      <div className="flex justify-center sm:justify-start items-center space-x-2 text-sm sm:text-base">
  ...
  return (
    <div className="flex justify-center space-x-2 items-center mt-4 sm:flex-row sm:justify-start sm:space-x-2">
      ...
      <div className="inline-flex space-x-2 items-center text-sm sm:text-base max-w-[70%] sm:max-w-[90%]">
        <a
          className="inline-block text-gray-800 dark:text-gray-200 font-medium truncate"
        ...
        <p className="inline-block text-gray-500 dark:text-gray-300 truncate">
          {nowPlaying.artist}
        </p>
      </div>
    </div>
