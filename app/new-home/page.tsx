    ...
    <div className="min-h-svh w-screen overflow-hidden">
      ...
      <main className="relative z-10 flex min-h-svh max-w-5xl flex-col justify-center gap-4 px-8 md:px-24 text-shadow-lg">
        <h1 className="max-w-6xl font-serif text-2xl font-medium md:mr-4 md:text-4xl">
          Welcome to my <span className="font-semibold">personal portfolio</span>, or as I like to
          call it, my <span className="italic underline">playground</span> on the web.
        </h1>
        <section>
          <p
          ...
          >
            ...
            I&apos;m passionate about creating beautiful, functional user experiences and enjoy
            working with a variety of technologies. I believe the best way to learn is by doing, so
            I&apos;m always exploring new projects. Currently, I&apos;m working as a Software
            Engineer at a{' '}
            <a
        ...
        <section className="flex space-x-4 items-center">
          <div>
            <p className="italic">More about me: </p>
            <div className="flex">
              <Link
