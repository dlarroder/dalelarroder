---
title: 'The JavaScript Promise and Async/Await'
date: '2022-04-20'
header: '/static/images/avatar.png'
tags: ['JavaScript', 'ReactJs', Snippets, 'Promises', 'Async/Await']
draft: false
author: 'Dale Larroder'
summary: 'A short visual guide what a Promise is in JavaScript, and how to avoid call back hell.'
---
...
![image](/static/blog/promises.png)
