...
$jscomp.polyfillUnisolated = function (l, p, m, r) {
  ...
  r = m[l];
  p = p(r);
  p != r && null != p && $jscomp.defineProperty(m, l, { configurable: !0, writable: !0, value: p });
};
...
$jscomp.polyfill(
  ...
  function (l) {
    ...
    k.prototype.settle_ = function (h, q) {
      if (0 != this.state_)
        throw Error(
          'Cannot settle(' + h + ', ' + q + '): Promise already settled in state' + this.state_
        );
      this.state_ = h;
      this.result_ = q;
    ...
    k.all = function (h) {
      ...
      return w.done
        ...
        : new k(function (B, v) {
            ...
            var I = [],
              J = 0;
            do I.push(void 0), J++, m(w.value).callWhenSettled_(D(I.length - 1), v), (w = q.next());
            while (!w.done);
          });
    };
    return k;
  ...
  return function (p) {
    ...
    (function () {
      function f(e, g) {
        ...
        0 == U &&
          (null !== ma && (clearInterval(ma), (ma = null)), aa && ((e = aa), (aa = null), e()));
      }
      function b(e) {
        f(e.instance);
      }
    ...
    var La = (a._emscripten_bind_VoidPtr___destroy___0 = function () {
      ...
      ua = (a._emscripten_bind_GeometryAttribute_GeometryAttribute_0 = function () {
        return (ua = a._emscripten_bind_GeometryAttribute_GeometryAttribute_0 = a.asm.i).apply(
          null,
          arguments
        );
      }),
      Ma = (a._emscripten_bind_GeometryAttribute___destroy___0 = function () {
        return (Ma = a._emscripten_bind_GeometryAttribute___destroy___0 = a.asm.j).apply(
          null,
          arguments
        );
      }),
      va = (a._emscripten_bind_PointAttribute_PointAttribute_0 = function () {
        return (va = a._emscripten_bind_PointAttribute_PointAttribute_0 = a.asm.k).apply(
          null,
          arguments
        );
      }),
      ...
      Oa = (a._emscripten_bind_PointAttribute_attribute_type_0 = function () {
        return (Oa = a._emscripten_bind_PointAttribute_attribute_type_0 = a.asm.m).apply(
          null,
          arguments
        );
      }),
      Pa = (a._emscripten_bind_PointAttribute_data_type_0 = function () {
        return (Pa = a._emscripten_bind_PointAttribute_data_type_0 = a.asm.n).apply(
          null,
          arguments
        );
      }),
      Qa = (a._emscripten_bind_PointAttribute_num_components_0 = function () {
        return (Qa = a._emscripten_bind_PointAttribute_num_components_0 = a.asm.o).apply(
          null,
          arguments
        );
      }),
      Ra = (a._emscripten_bind_PointAttribute_normalized_0 = function () {
        return (Ra = a._emscripten_bind_PointAttribute_normalized_0 = a.asm.p).apply(
          null,
          arguments
        );
      }),
      Sa = (a._emscripten_bind_PointAttribute_byte_stride_0 = function () {
        return (Sa = a._emscripten_bind_PointAttribute_byte_stride_0 = a.asm.q).apply(
          null,
          arguments
        );
      }),
      Ta = (a._emscripten_bind_PointAttribute_byte_offset_0 = function () {
        return (Ta = a._emscripten_bind_PointAttribute_byte_offset_0 = a.asm.r).apply(
          null,
          arguments
        );
      }),
      Ua = (a._emscripten_bind_PointAttribute_unique_id_0 = function () {
        return (Ua = a._emscripten_bind_PointAttribute_unique_id_0 = a.asm.s).apply(
          null,
          arguments
        );
      }),
      Va = (a._emscripten_bind_PointAttribute___destroy___0 = function () {
        return (Va = a._emscripten_bind_PointAttribute___destroy___0 = a.asm.t).apply(
          null,
          arguments
        );
      }),
      ...
      Wa = (a._emscripten_bind_PointCloud_num_attributes_0 = function () {
        return (Wa = a._emscripten_bind_PointCloud_num_attributes_0 = a.asm.v).apply(
          null,
          arguments
        );
      }),
      ...
      za = (a._emscripten_bind_DracoInt8Array_DracoInt8Array_0 = function () {
        return (za = a._emscripten_bind_DracoInt8Array_DracoInt8Array_0 = a.asm.G).apply(
          null,
          arguments
        );
      }),
      ...
      gb = (a._emscripten_bind_DracoInt8Array___destroy___0 = function () {
        return (gb = a._emscripten_bind_DracoInt8Array___destroy___0 = a.asm.J).apply(
          null,
          arguments
        );
      }),
      Aa = (a._emscripten_bind_MetadataBuilder_MetadataBuilder_0 = function () {
        return (Aa = a._emscripten_bind_MetadataBuilder_MetadataBuilder_0 = a.asm.K).apply(
          null,
          arguments
        );
      }),
      hb = (a._emscripten_bind_MetadataBuilder_AddStringEntry_3 = function () {
        return (hb = a._emscripten_bind_MetadataBuilder_AddStringEntry_3 = a.asm.L).apply(
          null,
          arguments
        );
      }),
      ib = (a._emscripten_bind_MetadataBuilder_AddIntEntry_3 = function () {
        return (ib = a._emscripten_bind_MetadataBuilder_AddIntEntry_3 = a.asm.M).apply(
          null,
          arguments
        );
      }),
      jb = (a._emscripten_bind_MetadataBuilder_AddIntEntryArray_4 = function () {
        return (jb = a._emscripten_bind_MetadataBuilder_AddIntEntryArray_4 = a.asm.N).apply(
          null,
          arguments
        );
      }),
      kb = (a._emscripten_bind_MetadataBuilder_AddDoubleEntry_3 = function () {
        return (kb = a._emscripten_bind_MetadataBuilder_AddDoubleEntry_3 = a.asm.O).apply(
          null,
          arguments
        );
      }),
      lb = (a._emscripten_bind_MetadataBuilder___destroy___0 = function () {
        return (lb = a._emscripten_bind_MetadataBuilder___destroy___0 = a.asm.P).apply(
          null,
          arguments
        );
      }),
      Ba = (a._emscripten_bind_PointCloudBuilder_PointCloudBuilder_0 = function () {
        return (Ba = a._emscripten_bind_PointCloudBuilder_PointCloudBuilder_0 = a.asm.Q).apply(
          null,
          arguments
        );
      }),
      mb = (a._emscripten_bind_PointCloudBuilder_AddFloatAttribute_5 = function () {
        return (mb = a._emscripten_bind_PointCloudBuilder_AddFloatAttribute_5 = a.asm.R).apply(
          null,
          arguments
        );
      }),
      nb = (a._emscripten_bind_PointCloudBuilder_AddInt8Attribute_5 = function () {
        return (nb = a._emscripten_bind_PointCloudBuilder_AddInt8Attribute_5 = a.asm.S).apply(
          null,
          arguments
        );
      }),
      ob = (a._emscripten_bind_PointCloudBuilder_AddUInt8Attribute_5 = function () {
        return (ob = a._emscripten_bind_PointCloudBuilder_AddUInt8Attribute_5 = a.asm.T).apply(
          null,
          arguments
        );
      }),
      pb = (a._emscripten_bind_PointCloudBuilder_AddInt16Attribute_5 = function () {
        return (pb = a._emscripten_bind_PointCloudBuilder_AddInt16Attribute_5 = a.asm.U).apply(
          null,
          arguments
        );
      }),
      qb = (a._emscripten_bind_PointCloudBuilder_AddUInt16Attribute_5 = function () {
        return (qb = a._emscripten_bind_PointCloudBuilder_AddUInt16Attribute_5 = a.asm.V).apply(
          null,
          arguments
        );
      }),
      rb = (a._emscripten_bind_PointCloudBuilder_AddInt32Attribute_5 = function () {
        return (rb = a._emscripten_bind_PointCloudBuilder_AddInt32Attribute_5 = a.asm.W).apply(
          null,
          arguments
        );
      }),
      sb = (a._emscripten_bind_PointCloudBuilder_AddUInt32Attribute_5 = function () {
        return (sb = a._emscripten_bind_PointCloudBuilder_AddUInt32Attribute_5 = a.asm.X).apply(
          null,
          arguments
        );
      }),
      tb = (a._emscripten_bind_PointCloudBuilder_AddMetadata_2 = function () {
        return (tb = a._emscripten_bind_PointCloudBuilder_AddMetadata_2 = a.asm.Y).apply(
          null,
          arguments
        );
      }),
      ub = (a._emscripten_bind_PointCloudBuilder_SetMetadataForAttribute_3 = function () {
        return (ub = a._emscripten_bind_PointCloudBuilder_SetMetadataForAttribute_3 =
          a.asm.Z).apply(null, arguments);
      }),
      vb = (a._emscripten_bind_PointCloudBuilder_SetNormalizedFlagForAttribute_3 = function () {
        return (vb = a._emscripten_bind_PointCloudBuilder_SetNormalizedFlagForAttribute_3 =
          a.asm._).apply(null, arguments);
      }),
      wb = (a._emscripten_bind_PointCloudBuilder___destroy___0 = function () {
        return (wb = a._emscripten_bind_PointCloudBuilder___destroy___0 = a.asm.$).apply(
          null,
          arguments
        );
      }),
      Ca = (a._emscripten_bind_MeshBuilder_MeshBuilder_0 = function () {
        return (Ca = a._emscripten_bind_MeshBuilder_MeshBuilder_0 = a.asm.aa).apply(
          null,
          arguments
        );
      }),
      xb = (a._emscripten_bind_MeshBuilder_AddFacesToMesh_3 = function () {
        return (xb = a._emscripten_bind_MeshBuilder_AddFacesToMesh_3 = a.asm.ba).apply(
          null,
          arguments
        );
      }),
      yb = (a._emscripten_bind_MeshBuilder_AddFloatAttributeToMesh_5 = function () {
        return (yb = a._emscripten_bind_MeshBuilder_AddFloatAttributeToMesh_5 = a.asm.ca).apply(
          null,
          arguments
        );
      }),
      zb = (a._emscripten_bind_MeshBuilder_AddInt32AttributeToMesh_5 = function () {
        return (zb = a._emscripten_bind_MeshBuilder_AddInt32AttributeToMesh_5 = a.asm.da).apply(
          null,
          arguments
        );
      }),
      Ab = (a._emscripten_bind_MeshBuilder_AddMetadataToMesh_2 = function () {
        return (Ab = a._emscripten_bind_MeshBuilder_AddMetadataToMesh_2 = a.asm.ea).apply(
          null,
          arguments
        );
      }),
      ...
      Cb = (a._emscripten_bind_MeshBuilder_AddInt8Attribute_5 = function () {
        return (Cb = a._emscripten_bind_MeshBuilder_AddInt8Attribute_5 = a.asm.ga).apply(
          null,
          arguments
        );
      }),
      Db = (a._emscripten_bind_MeshBuilder_AddUInt8Attribute_5 = function () {
        return (Db = a._emscripten_bind_MeshBuilder_AddUInt8Attribute_5 = a.asm.ha).apply(
          null,
          arguments
        );
      }),
      Eb = (a._emscripten_bind_MeshBuilder_AddInt16Attribute_5 = function () {
        return (Eb = a._emscripten_bind_MeshBuilder_AddInt16Attribute_5 = a.asm.ia).apply(
          null,
          arguments
        );
      }),
      Fb = (a._emscripten_bind_MeshBuilder_AddUInt16Attribute_5 = function () {
        return (Fb = a._emscripten_bind_MeshBuilder_AddUInt16Attribute_5 = a.asm.ja).apply(
          null,
          arguments
        );
      }),
      Gb = (a._emscripten_bind_MeshBuilder_AddInt32Attribute_5 = function () {
        return (Gb = a._emscripten_bind_MeshBuilder_AddInt32Attribute_5 = a.asm.ka).apply(
          null,
          arguments
        );
      }),
      Hb = (a._emscripten_bind_MeshBuilder_AddUInt32Attribute_5 = function () {
        return (Hb = a._emscripten_bind_MeshBuilder_AddUInt32Attribute_5 = a.asm.la).apply(
          null,
          arguments
        );
      }),
      Ib = (a._emscripten_bind_MeshBuilder_AddMetadata_2 = function () {
        return (Ib = a._emscripten_bind_MeshBuilder_AddMetadata_2 = a.asm.ma).apply(
          null,
          arguments
        );
      }),
      Jb = (a._emscripten_bind_MeshBuilder_SetMetadataForAttribute_3 = function () {
        return (Jb = a._emscripten_bind_MeshBuilder_SetMetadataForAttribute_3 = a.asm.na).apply(
          null,
          arguments
        );
      }),
      Kb = (a._emscripten_bind_MeshBuilder_SetNormalizedFlagForAttribute_3 = function () {
        return (Kb = a._emscripten_bind_MeshBuilder_SetNormalizedFlagForAttribute_3 =
          a.asm.oa).apply(null, arguments);
      }),
      Lb = (a._emscripten_bind_MeshBuilder___destroy___0 = function () {
        return (Lb = a._emscripten_bind_MeshBuilder___destroy___0 = a.asm.pa).apply(
          null,
          arguments
        );
      }),
      ...
      Mb = (a._emscripten_bind_Encoder_SetEncodingMethod_1 = function () {
        return (Mb = a._emscripten_bind_Encoder_SetEncodingMethod_1 = a.asm.ra).apply(
          null,
          arguments
        );
      }),
      Nb = (a._emscripten_bind_Encoder_SetAttributeQuantization_2 = function () {
        return (Nb = a._emscripten_bind_Encoder_SetAttributeQuantization_2 = a.asm.sa).apply(
          null,
          arguments
        );
      }),
      Ob = (a._emscripten_bind_Encoder_SetAttributeExplicitQuantization_5 = function () {
        return (Ob = a._emscripten_bind_Encoder_SetAttributeExplicitQuantization_5 =
          a.asm.ta).apply(null, arguments);
      }),
      Pb = (a._emscripten_bind_Encoder_SetSpeedOptions_2 = function () {
        return (Pb = a._emscripten_bind_Encoder_SetSpeedOptions_2 = a.asm.ua).apply(
          null,
          arguments
        );
      }),
      Qb = (a._emscripten_bind_Encoder_SetTrackEncodedProperties_1 = function () {
        return (Qb = a._emscripten_bind_Encoder_SetTrackEncodedProperties_1 = a.asm.va).apply(
          null,
          arguments
        );
      }),
      Rb = (a._emscripten_bind_Encoder_EncodeMeshToDracoBuffer_2 = function () {
        return (Rb = a._emscripten_bind_Encoder_EncodeMeshToDracoBuffer_2 = a.asm.wa).apply(
          null,
          arguments
        );
      }),
      Sb = (a._emscripten_bind_Encoder_EncodePointCloudToDracoBuffer_3 = function () {
        return (Sb = a._emscripten_bind_Encoder_EncodePointCloudToDracoBuffer_3 = a.asm.xa).apply(
          null,
          arguments
        );
      }),
      Tb = (a._emscripten_bind_Encoder_GetNumberOfEncodedPoints_0 = function () {
        return (Tb = a._emscripten_bind_Encoder_GetNumberOfEncodedPoints_0 = a.asm.ya).apply(
          null,
          arguments
        );
      }),
      Ub = (a._emscripten_bind_Encoder_GetNumberOfEncodedFaces_0 = function () {
        return (Ub = a._emscripten_bind_Encoder_GetNumberOfEncodedFaces_0 = a.asm.za).apply(
          null,
          arguments
        );
      }),
      ...
      Ea = (a._emscripten_bind_ExpertEncoder_ExpertEncoder_1 = function () {
        return (Ea = a._emscripten_bind_ExpertEncoder_ExpertEncoder_1 = a.asm.Ba).apply(
          null,
          arguments
        );
      }),
      Wb = (a._emscripten_bind_ExpertEncoder_SetEncodingMethod_1 = function () {
        return (Wb = a._emscripten_bind_ExpertEncoder_SetEncodingMethod_1 = a.asm.Ca).apply(
          null,
          arguments
        );
      }),
      Xb = (a._emscripten_bind_ExpertEncoder_SetAttributeQuantization_2 = function () {
        return (Xb = a._emscripten_bind_ExpertEncoder_SetAttributeQuantization_2 = a.asm.Da).apply(
          null,
          arguments
        );
      }),
      Yb = (a._emscripten_bind_ExpertEncoder_SetAttributeExplicitQuantization_5 = function () {
        return (Yb = a._emscripten_bind_ExpertEncoder_SetAttributeExplicitQuantization_5 =
          a.asm.Ea).apply(null, arguments);
      }),
      Zb = (a._emscripten_bind_ExpertEncoder_SetSpeedOptions_2 = function () {
        return (Zb = a._emscripten_bind_ExpertEncoder_SetSpeedOptions_2 = a.asm.Fa).apply(
          null,
          arguments
        );
      }),
      $b = (a._emscripten_bind_ExpertEncoder_SetTrackEncodedProperties_1 = function () {
        return ($b = a._emscripten_bind_ExpertEncoder_SetTrackEncodedProperties_1 = a.asm.Ga).apply(
          null,
          arguments
        );
      }),
      ac = (a._emscripten_bind_ExpertEncoder_EncodeToDracoBuffer_2 = function () {
        return (ac = a._emscripten_bind_ExpertEncoder_EncodeToDracoBuffer_2 = a.asm.Ha).apply(
          null,
          arguments
        );
      }),
      bc = (a._emscripten_bind_ExpertEncoder_GetNumberOfEncodedPoints_0 = function () {
        return (bc = a._emscripten_bind_ExpertEncoder_GetNumberOfEncodedPoints_0 = a.asm.Ia).apply(
          null,
          arguments
        );
      }),
      cc = (a._emscripten_bind_ExpertEncoder_GetNumberOfEncodedFaces_0 = function () {
        return (cc = a._emscripten_bind_ExpertEncoder_GetNumberOfEncodedFaces_0 = a.asm.Ja).apply(
          null,
          arguments
        );
      }),
      dc = (a._emscripten_bind_ExpertEncoder___destroy___0 = function () {
        return (dc = a._emscripten_bind_ExpertEncoder___destroy___0 = a.asm.Ka).apply(
          null,
          arguments
        );
      }),
      ...
      fc = (a._emscripten_enum_draco_GeometryAttribute_Type_POSITION = function () {
        return (fc = a._emscripten_enum_draco_GeometryAttribute_Type_POSITION = a.asm.Ma).apply(
          null,
          arguments
        );
      }),
      gc = (a._emscripten_enum_draco_GeometryAttribute_Type_NORMAL = function () {
        return (gc = a._emscripten_enum_draco_GeometryAttribute_Type_NORMAL = a.asm.Na).apply(
          null,
          arguments
        );
      }),
      ...
      ic = (a._emscripten_enum_draco_GeometryAttribute_Type_TEX_COORD = function () {
        return (ic = a._emscripten_enum_draco_GeometryAttribute_Type_TEX_COORD = a.asm.Pa).apply(
          null,
          arguments
        );
      }),
      jc = (a._emscripten_enum_draco_GeometryAttribute_Type_GENERIC = function () {
        return (jc = a._emscripten_enum_draco_GeometryAttribute_Type_GENERIC = a.asm.Qa).apply(
          null,
          arguments
        );
      }),
      kc = (a._emscripten_enum_draco_EncodedGeometryType_INVALID_GEOMETRY_TYPE = function () {
        return (kc = a._emscripten_enum_draco_EncodedGeometryType_INVALID_GEOMETRY_TYPE =
          a.asm.Ra).apply(null, arguments);
      }),
      lc = (a._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD = function () {
        return (lc = a._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD = a.asm.Sa).apply(
          null,
          arguments
        );
      }),
      mc = (a._emscripten_enum_draco_EncodedGeometryType_TRIANGULAR_MESH = function () {
        return (mc = a._emscripten_enum_draco_EncodedGeometryType_TRIANGULAR_MESH = a.asm.Ta).apply(
          null,
          arguments
        );
      }),
      nc = (a._emscripten_enum_draco_MeshEncoderMethod_MESH_SEQUENTIAL_ENCODING = function () {
        return (nc = a._emscripten_enum_draco_MeshEncoderMethod_MESH_SEQUENTIAL_ENCODING =
          a.asm.Ua).apply(null, arguments);
      }),
      oc = (a._emscripten_enum_draco_MeshEncoderMethod_MESH_EDGEBREAKER_ENCODING = function () {
        return (oc = a._emscripten_enum_draco_MeshEncoderMethod_MESH_EDGEBREAKER_ENCODING =
    ...
    var n = {
      ...
      alloc: function (b, c) {
        ...
        b = (b + 7) & -8;
        n.pos + b >= n.size
          ? (0 < b || k(void 0), (n.needed += b), (c = a._malloc(b)), n.temps.push(c))
    ...
    u.prototype.AddFloatAttributeToMesh = u.prototype.AddFloatAttributeToMesh = function (
      b,
      c,
      d,
      e,
    ...
    u.prototype.AddInt32AttributeToMesh = u.prototype.AddInt32AttributeToMesh = function (
      b,
      c,
      d,
      e,
    ...
    u.prototype.SetNormalizedFlagForAttribute = u.prototype.SetNormalizedFlagForAttribute =
      function (b, c, d) {
        var e = this.ptr;
        b && 'object' === typeof b && (b = b.ptr);
        c && 'object' === typeof c && (c = c.ptr);
